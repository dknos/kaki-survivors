...
| P4A | ↳ Cohort progress | **Cohort 1 of N shipped** (2026-05-18) — skeleton + palette doc + boot integration + smoke phase 1. STAGES entry, `src/stages/cave/{cavePalette,caveStage}.js`, main.js stage-resolve + dispose wire-up, assets.js preloadStage cave arm, menuV2 STAGE_ART card, `docs/CAVE_VISUAL_STYLE.md`, `tools/smoke-cave-v2.mjs` phase 1 only. P4K STAGE_AUTHORING.md draft co-shipped. Cohorts c2…cN land rooms / weapons / hazards / neutrals / landmarks / music / textures / achievements one per cron tick. Acceptance ✅ flips when cohort N closes. |
